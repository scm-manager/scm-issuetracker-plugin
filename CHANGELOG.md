...
## Unreleased (3.0.0)
### Added 
- Support for pull request and comments ([#10](https://github.com/scm-manager/scm-issuetracker-plugin/pull/10))
### Changed
- Complete new api ([#10](https://github.com/scm-manager/scm-issuetracker-plugin/pull/10))
